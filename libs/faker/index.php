...
//     }
     ...
     for($i = 0; $i< 20; $i++){
     $sql = "INSERT INTO approvisionnement (qteAppro, dateAppro, prixU , idProd, idFournis, etat) 
     VALUES ('" . $faker->numberBetween(20, 200) . "', '" . $faker->date('Y-m-d') . "', '" .$faker->numberBetween(200, 1000) . "', '" . $faker->numberBetween(1, 10) . "','" . $faker->numberBetween(1, 10) . "' , 'supprimer')";
